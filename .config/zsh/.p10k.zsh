# Generated by Powerlevel10k configuration wizard on 2024-01-21 at 19:42 -05.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=bright-white
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=yellow
  ...
  #
   typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~'                HOME              ''
    '~/Downloads'      DOWNLOADS         ''
    '~/Downloads/*'    DOWNLOADS_SUB     ''
    '~/Documents'      DOCUMENTS         '󰈙'
    '~/Documents/*'    DOCUMENTS_SUB     '󰈙'
    '~/Pictures'       PICTURES          ''
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%5F'  # magenta default foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=9
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_NODE_VERSION_VISUAL_IDENTIFIER_EXPANSION='%fvia %2F'
